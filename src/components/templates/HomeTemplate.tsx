      ...
      <div className="flex justify-center sm:justify-end mb-6">
        <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-end w-full sm:w-auto rounded-full border-2 border-blue-200 relative sm:space-y-0">
          <div className="w-full sm:w-64">
            <input
              type="text"
              className="cursor-pointer text-gray-900 text-center block w-full rounded-3xl outline-none border-none p-3 transition-opacity duration-200 hover:bg-slate-200"
          ...
          <input
            disabled
            type="text"
            className="cursor-default text-gray-900 text-center block w-full sm:w-32 rounded-3xl outline-none border-none p-3 transition-opacity duration-200 hover:bg-slate-200"
